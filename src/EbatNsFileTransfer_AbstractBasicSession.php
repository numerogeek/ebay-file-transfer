...
abstract class EbatNsFileTransfer_AbstractBasicSession
{
    private $appModeUrls;
    ...
    public function curl()
    {
        ...
        return (new EbatNsFileTransfer_Curler($timeout))
            ->withApiUrl($apiUrl)
    ...
    public function getXmlCredentialHeaders()
    {
        ...
        $headers = [
            ...
            'X-EBAY-API-VERSION: 1.1.0',
            'X-EBAY-API-COMPATIBILITY-LEVEL: 1.1.0'
        ];
    ...
    public function getSoapCredentialHeaders()
    {
        ...
        if ($requestToken) {
            $headers[] = 'X-EBAY-SOA-SECURITY-TOKEN: ' . $requestToken;
        }
     ...
     *
     * @return EbatNsFileTransfer_Defines::APPMODE_* Value of the AppMode property
     */
     ...
     *
     * @param EbatNsFileTransfer_Defines::APPMODE_* $value
     */
    ...
    */
    ...
    {
        $entry = EbatNsFileTransfer_Defines::getGlobalIdEntry($value);
    ...
    public function initFromConfig($configFile)
    {
        ...
        if (isset($cfg['app-key-test'])) {
            $this->keys['test'][0] = $cfg['app-key-test'];
        }

        if (isset($cfg['app-key-prod'])) {
            $this->keys['prod'][0] = $cfg['app-key-prod'];
        }
    ...
    {
        return $this->useStandardLogger
            ? new EbatNsFileTransfer_Logger(true, 'stdout', true, true)
            : null;
    }
