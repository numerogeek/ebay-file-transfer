...
class EbatNsFileTransfer_DecodedResponse
{
    /**
    * @var null|string
    */
    ...
    */
    ...
    /**
    * @var EbatNsFileTransfer_DecodedResponse[] e.g. multipart contents
    */
    protected $files = [];
    ...
    public function getObject()
    {
        ...
        return is_string($content) ? new EbatNsFileTransfer_ResponseError($content) : $content;
    }
