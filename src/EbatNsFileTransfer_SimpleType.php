 ...
 */
class EbatNsFileTransfer_SimpleType
{
    const TAG = '';
    const NAME = 'EbatNsFileTransfer_SimpleType';
    const XMLNS = 'http://www.w3.org/2001/XMLSchema';
    const REQUEST = null;

    protected static $_attributes = [
        /* pre-registered attributes */
        'EbatNsFileTransfer_SimpleType' => [],
        'EbatNsFileTransfer_EnumType' => [],
        'EbatNsFileTransfer_ComplexType' => []
    ];
    ...
    protected static function _bool($value)
    {
        ...
        $isTrue = (is_string($value) && strtolower($value) !== 'false') || boolval($value);
    ...
    */
     ...
     * @depricated
     */
    public function setTypeAttribute($key, $value)
    {
        $this->assignTagAttribute($key, $value);
    }
    ...
    {
        return $this->getTagAttribute($key);
    }
